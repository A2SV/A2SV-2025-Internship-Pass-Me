      ...
      >
        <div className="flex justify-between items-center p-4 py-10">
          ...
          <button
            ...
            className="w-[260px] h-[40px] px-16 flex items-center justify-center gap-2 rounded-[12px] bg-white hover:bg-neutral-200 text-black mx-auto transition-colors cursor-pointer"
          >
