...
const LoginForm = () => {
  ...
  <div className="mb-8 relative">
    <input
      ...
      className="w-70 md:w-full h-14 px-3 py-2 border border-[#4242423] rounded-md opacity-70 placeholder:text-sm focus:outline-none"
    />
...
<input
      ...
      <button
        ...
        className=" md:absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
      >
        {showPassword ? (
  ...
  <div className="mb-8 relative md: flex justify-between">
